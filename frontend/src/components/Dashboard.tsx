            ...
            {profileLoading ? (
               ...
               <>
                 ...
                 <div style={{ textAlign: 'center' }}>
                   <p style={{ fontFamily: 'var(--dg-font-heading)', fontWeight: 700, fontSize: '1.0625rem', color: 'var(--dg-text-primary)' }}>{profile?.name || profile?.email?.split('@')[0] || 'Anonymous User'}</p>
